        ...
        <div class="d-flex flex-column flex-lg-row mb-17" style="padding-top:50px">
                ...
                <!--begin::Form-->
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--end::Label-->
                            <label class="fs-5 fw-semibold mb-2">New supplier</label> <!--end::Label-->
                             <!--end::Input-->
                             <input class="form-control form-control-solid" name="supplier" placeholder="supplier" type="text"> <!--end::Input-->
           ...
           <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">  
                                    <button class="btn btn-light btn-active-light-danger me-2" type="reset" style="font-size:8px" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_{{$supplier->id}}">Delete </button>
                                    <button class="btn btn-light btn-active-light-danger me-2" type="reset" style="font-size:8px" data-bs-toggle="modal" data-bs-target="#kt_modal_disable_{{$supplier->id}}">Disable </button>
                                    <button class="btn btn-light btn-active-light-primary me-2" type="reset" style="font-size:8px" data-bs-toggle="modal" data-bs-target="#kt_modal_enable_{{$supplier->id}}">Enable </button> 
                                    <button class="btn btn-primary btn-active-light-primary me-2" type="reset" style="font-size:8px;" data-bs-toggle="modal" data-bs-target="#kt_modal_update_{{$supplier->id}}">Update</button> 
                                 </td>
                                <!--end::Product=-->
                                <!--begin::SKU=-->
                            ...
                            <div class="modal fade" tabindex="-1" id="kt_modal_delete_{{$supplier->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title">{{$supplier->supplier}}	</h3>
                            ...
                            <div class="modal fade" tabindex="-1" id="kt_modal_disable_{{$supplier->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title">{{$supplier->supplier}}	</h3>
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_enable_{{$supplier->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">{{$supplier->supplier}}	</h3>
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_update_{{$supplier->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">{{$supplier->supplier}}	</h3>
                                    ...
                                    <form action="{{route('admin.supplier.update',[ 'supplier'=> $supplier->id ])}}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                                <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="supplier" placeholder="supplier" type="text" value="{{$supplier->supplier}}">
                                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                                            </div>
