            ...
            <div class="flex-lg-row-fluid me-0 me-lg-20">
                <!--begin::Form-->
                    ...
                    <div class="row mb-5">
                     ...
                     <form action="{{route('shop.printsettinginvoice.store')}}" method="post">
                        @csrf
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--end::Label-->
                            <label class="fs-5 fw-semibold mb-2">Invoice Receipt Header</label> <!--end::Label-->
                             <!--end::Input-->
                             <textarea class="form-control form-control-solid" rows="10" id="tinymce1" name="header">{{old('header')??(Auth::user()->invoiceSetting(1)->header??'')}} </textarea>  
                    ...
                    <div class="row mb-5">
                     ...
                     <form action="{{route('shop.printsettinginvoice.store')}}" method="post">
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--end::Label-->
                            <label class="fs-5 fw-semibold mb-2">Invoice receipt Text General</label> <!--end::Label-->
                             <!--end::Input-->
                             <textarea class="form-control form-control-solid" rows="10" id="tinymce2" name="general"> {{old('general')??(Auth::user()->invoiceSetting(1)->general??'')}}</textarea>  
                    ...
                    <div class="row mb-5">
                     ...
                     <form action="{{route('shop.printsettinginvoice.store')}}" method="post">
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <!--end::Label-->
                            <label class="fs-5 fw-semibold mb-2">Invoice receipt footer</label> <!--end::Label-->
                             <!--end::Input-->
                             <textarea class="form-control form-control-solid" rows="10" id="tinymce3" name="footer">{{old('footer')??(Auth::user()->invoiceSetting(1)->footer??'')}} </textarea>  
