            ...
            <div class="col-lg-8">
                <form class="login-form default-form-wrap">
                    <div class="single-input-wrap mb-4">
                        ...
                        <span style="display: block;">Thanks for booking an order,we have sent ou email with order status code please note down order status code</span>
                        <span style="display: block;">Order Status Code : {{$statusCode??''}}</span>
                    </div>
