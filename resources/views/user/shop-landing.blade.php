                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light px-0">
                        <a class="navbar-brand" href="/">
                            <img src="{{$shop->logo?asset('storage/'.$shop->logo) : asset('assets/cms-theme/assets/images/logo.png')}}" alt="logo">
                            <!-- logo -->
                        </a>
...
<header class="cm-header header-four">
    ...
    <div class="header">
        <div class="container h-100">
            <a class="navbar-brand" href="/">
                <img src="{{asset($shop->logo?asset('storage/'.$shop->logo) : 'assets/cms-theme/assets/images/logo.png')}}" alt="logo" width="210" height="120">
                <!-- logo -->
            </a>
            <div class="row h-100 align-content-center">
                <div class="col-md-12">
        ...
        <div class="row h-100 align-items-center">
            <div class="col-lg-7">
                <div class="banner-inner">
                    ...
                    <div class="btn-area">
                        <a class="btn btn-primary" href="{{route('place.order.mobile.repair',['username'=>$shop->subdomain])}}">Book A Service</a>
                    </div>
                </div>
            </div>
        </div>
