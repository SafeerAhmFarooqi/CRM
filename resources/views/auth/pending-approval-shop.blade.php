        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form class="login-form default-form-wrap" method="POST" action="{{ route('logout') }}">
                  ...
                  <p>Thanks for signing up! Before getting started, your shop account must be approved from Administrator. Please wait until your account is approved.You will recieve email notification on account approval</p>
