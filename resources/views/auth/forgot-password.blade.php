...
<div class="login-area section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form class="login-form default-form-wrap" method="POST" action="{{ route('password.email') }}">
                    @csrf
                    <div class="single-input-wrap mb-4">
                        <label class="form-label">Email</label>
                        <span style="display: block;">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</span>
