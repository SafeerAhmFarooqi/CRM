...
<div class="login-area section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form class="login-form default-form-wrap" method="POST" action="{{ route('login') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-sm-right align-self-center">
                            <a class="reset-pass" href="{{route('password.request')}}">Forgot your password?</a>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w-100">Login</button>
                    <p>New user?<a href="{{route('register')}}">Don't have an account?</a></p>
                </form>
            </div>
        </div>
    </div>
