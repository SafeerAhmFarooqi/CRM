...
class ShopPrintSettingInvoiceController extends BaseShopController
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboards.shop.print-setting-invoice-page');
    }
    ...
    public function store(Request $request)
    {
        if ($request->field==1) {
            ...
            if (Auth::user()->invoiceSetting(1)) {
                $invoiceSetting=Auth::user()->invoiceSetting(1)->update([
