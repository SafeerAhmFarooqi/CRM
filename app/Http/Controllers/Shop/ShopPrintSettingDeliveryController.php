...
class ShopPrintSettingDeliveryController extends BaseShopController
{
    /**
    ...
    {
        return view('dashboards.shop.print-setting-delivery-page');
    }
    ...
    public function store(Request $request)
    {
        if ($request->field==1) {
            ...
            if (Auth::user()->invoiceSetting(3)) {
                $invoiceSetting=Auth::user()->invoiceSetting(3)->update([
