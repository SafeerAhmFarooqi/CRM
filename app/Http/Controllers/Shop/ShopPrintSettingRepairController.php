...
class ShopPrintSettingRepairController extends BaseShopController
{
    /**
    ...
    {
        return view('dashboards.shop.print-setting-repair-page');
    }
    ...
    public function store(Request $request)
    {
        if ($request->field==1) {
            ...
            if (Auth::user()->invoiceSetting(4)) {
                $invoiceSetting=Auth::user()->invoiceSetting(4)->update([
